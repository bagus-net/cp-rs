...
<div class="container mt-4">
    <div class="row text-center">
        <div class="col-12">
            ...
            <h3 class="section-sub-title">Puskesmas Pembantu</h3>
        </div>
    </div>
                ...
                <div class="item">
                    <div class="ts-team-wrapper">
                        ...
                        <div class="ts-team-content">
                            <p class="text-white"> <Strong>Nama Pustu</Strong></p>
                            <p class="ts-designation">Alamat pustu</p>
                            <div class="team-social-icons">
                                <a class="btn btn-primary" href="#"><small class="text-small">Lihat Detail</small> <i class="fas fa-arrow-right"></i></a>
                            </div>
                        </div>
                    </div>
                </div>
